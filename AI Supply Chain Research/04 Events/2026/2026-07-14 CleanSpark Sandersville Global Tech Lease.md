...
# Event: CleanSpark signs 175 MW Sandersville lease with global technology company

## Facts

- CleanSpark filed an 8-K on July 14, 2026 disclosing that on July 10, 2026 it entered into an infrastructure lease agreement with a leading global technology company with a high investment-grade credit profile.
- The lease covers data-center infrastructure at CleanSpark's Sandersville, Georgia campus supporting 175 MW of critical information technology load.
- CleanSpark says the lease is a triple-net structure with annual escalators and an initial 20-year term; the tenant has two five-year extension options.
- Exhibit 99.1 says the lease is expected to generate approximately $6.6 billion of contracted revenue over the initial term, or approximately $11.6 billion if both five-year extension options are exercised.
- CleanSpark says deliveries are expected to begin in Q4 2027.
...
- AI/HPC datacenter site selection, power capacity, and campus construction.
- High-density compute deployment capacity for an unnamed global technology tenant.
- Electrical infrastructure, cooling, construction, and grid-interconnection suppliers indirectly exposed to MW-scale AI campus buildouts.
- Public-market datacenter developer cohort that includes former bitcoin miners and power-rich infrastructure owners converting land/power portfolios into AI/HPC lease revenue.
...
- Universe: public datacenter developers, power-rich former bitcoin miners, GPU-cloud providers, electrical/cooling suppliers, construction contractors, and related infrastructure names.
- Signal: primary-sourced AI/HPC datacenter lease or delivery announcements with disclosed critical IT load, tenant quality, contract value, lease term, and delivery/rent schedule.
- Target variable: 0-5 trading-day returns for direct developers and 1-4 quarter backlog/revenue revisions for electrical/cooling and construction suppliers.
- Expected lead/lag: immediate reaction for CLSK/direct developer peers; longer lag for suppliers as construction orders and commissioning milestones appear.
- Data requirements: SEC filings, press releases, MW fields, tenant identity/credit quality, contracted revenue, financing conditions, delivery/rent commencement dates, and follow-on equipment/procurement disclosures.

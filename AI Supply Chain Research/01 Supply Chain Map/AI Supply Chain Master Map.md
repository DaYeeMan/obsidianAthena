...
Key entities: OpenAI, Anthropic, xAI, CoreWeave, Lambda, Crusoe, Nebius, IREN, Galaxy/Helios, Applied Digital, CleanSpark, MARA, Hut 8/Beacon Point, Coravel/ACS/GIP, Microsoft Azure, Google Cloud/Alphabet, AWS, Oracle Cloud.
...
| Datacenter power | Are power/interconnection constraints becoming a more important limiter than chip availability? | [[03 Segments/Datacenter Power Cooling and Construction]] | Primary Alphabet evidence now adds a hyperscaler-scale capex/lease-demand layer: $80.6B H1 2026 capex and $85.2B of non-commenced data-center lease payments, alongside primary TeraWulf/Anthropic 401 MW lease evidence, Galaxy/Helios 133 MW delivered critical IT load to CoreWeave plus priced $3.507B / 9.875% financing for 260 MW critical IT load at Helios Phase II, Applied Digital 210 MW Delta Forge 2 hyperscaler lease, CleanSpark 175 MW Sandersville lease plus 885 MW Texas exclusivity, Hut 8 second 352 MW Beacon Point lease / 1,000 MW utility-capacity campus commercialization, IREN $2.8B AI cloud contracts tied to 480 MW 2026 delivery / 1.2 GW 2027 target, Applied Digital 75 MW Polaris Forge 1 operational delivery, MARA/HIF Matagorda 2 GW powered-site pipeline, and high-quality DCD evidence of Coravel/ACS/GIP's 140 MW hyperscaler DFW agreement and 1.7 GW development portfolio; execution milestones still needed for future phases and site-control/platform events without primary economics are lower-certainty than SEC-filed signed leases/deliveries/financings. |

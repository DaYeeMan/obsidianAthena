...
- crowding/arbitrage
- obsolete market microstructure
- unrealistic transaction costs
- inaccessible data or execution
- model complexity not justified versus simple baselines

## Foundational Items to Preserve

Important papers/models that may not be directly tradable but remain useful for concepts, baselines, or research design.

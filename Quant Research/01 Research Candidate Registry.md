...
| CryptoGAT / price-only crypto sequence-model skepticism | Crypto / ML | Forecasting baseline / model warning | Plausible but untested | retail-adaptable / outdated-watch | Medium | High: crypto regimes change quickly; price-only DL often fails after fees | 2026-06-28 | [[2026-06-28 Daily Quant Research Review]] | Preserve as warning; require naive, momentum, reversal, vol, funding, and basis baselines before complex models. |

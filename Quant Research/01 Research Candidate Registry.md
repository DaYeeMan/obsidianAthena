...
| SPX/SPXW short-dated put-writing with VIX and fractional-Kelly sizing | Options / equities | Volatility risk premium; position sizing | Plausible but untested | retail-adaptable | High | High: crowded short-vol, 0DTE market-structure shift, crash risk, bid/ask realism, margin/cash treatment, and volatility underprediction can dominate sizing rules | 2026-07-05 | [[SPX Short-Dated Put-Writing with VIX and Fractional-Kelly Sizing]] | Create fixed-risk baseline spec first with bid/worse fills, cash/margin, regime splits, crash scenarios, and audit-block outputs before adding VIX/Kelly or specialist-volatility routing. |

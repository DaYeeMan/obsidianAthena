...
| Standard cost/regime/liquidity/decision audit block for backtests | Equities / options / crypto / futures / portfolio | High | Ready to code as reusable report module | Backtest trades/weights, asset prices/returns, turnover, spread or liquidity proxies, fold metrics, baseline returns, regime covariates, availability/reference/decision timestamps where available | Integrate into a backtest harness and define minimal proxy defaults when bid/ask or intraday data are unavailable | [[2026-07-05 Weekly Quant Synthesis and Strategy Decay Review]]; [[2026-07-12 Weekly Quant Synthesis and Strategy Decay Review]]; [[2026-07-19 Weekly Quant Synthesis and Strategy Decay Review]]; [[Framework Candidate Registry]] | Implement a report block with TimeGate/leakage checklist, planted-leak controls where possible, survivorship/replication guardrails, base-rate/always-up and simple-rule baselines, deployment gates, turnover/cost stress, liquidity-demand/tail and venue-quality proxies, manipulation-like RL/execution diagnostics, action-attribution for risk filters, PSI/JSD/KL drift false-alarm/power checks, feature-aware calibration, dependence-aware interval/fold uncertainty, regime-conditioned fold metrics, and decision-regret outputs. |
